package ru.practicum.explorewithme.user.error;
...
import ru.practicum.explorewithme.user.error.exception.NotFoundException;
...
public class GlobalExceptionHandler {
    static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern(DATE_TIME_FORMAT);
